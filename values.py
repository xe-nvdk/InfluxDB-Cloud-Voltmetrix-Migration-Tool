# Define the source
src_instance = "https://us-west-2-1.aws.cloud2.influxdata.com" # Enter your InfluxDB Cloud URL (Ex: https://us-west-2-1.aws.cloud2.influxdata.com).
...
dst_instance = "" # Enter your InfluxDB hosted in Voltmetrix. (Ex: https://544657bw2.customers.voltmetrix.io:8086).
